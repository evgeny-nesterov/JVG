...
public class MutableGeneralPathIterator implements PathIterator {
	int typeIdx = 0;
	...
	MutableGeneralPathIterator(MutableGeneralPath path) {
		this(path, null);
	}

	MutableGeneralPathIterator(MutableGeneralPath path, AffineTransform at) {
		this.path = path;
		this.affine = at;
	}
