...
public class JVGScaleRelativeShapeTransformElement extends JVGRelativeRectTransformElement {
	public double x;
	...
	public JVGScaleRelativeShapeTransformElement(int rectType, double sx, double sy, boolean sxpercent, boolean sypercent, double x, double y) {
		super(rectType);
		this.x = x;
		this.y = y;
		this.sx = sx;
