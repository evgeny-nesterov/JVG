...
/**
 * This is the superclass for Paints which use a multiple color gradient to fill in their raster. It provides storage for variables and
...
public abstract class MultipleGradientPaint implements Paint {
	...
	/**
	 * Indicates (if the gradient starts or ends inside the target region), to cycle the gradient colors start-to-end, end-to-start to fill the
	 * remaining area.
	 */
	public static final CycleMethodEnum REFLECT = new CycleMethodEnum();

	/**
	 * Indicates (if the gradient starts or ends inside the target region), to cycle the gradient colors start-to-end, start-to-end to fill the
	 * remaining area.
	 */
	 ...
	 * 
	 * @return an integer value representing this LinearGradientPaint object's transparency mode.
