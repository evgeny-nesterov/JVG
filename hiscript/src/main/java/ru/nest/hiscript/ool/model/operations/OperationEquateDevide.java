...
public class OperationEquateDevide extends BinaryOperation {
	private static Operation instance = new OperationEquateDevide();

	public static Operation getInstance() {
		return instance;
	}

	private OperationEquateDevide() {
		super("/=", EQUATE_DIVIDE);
	}
