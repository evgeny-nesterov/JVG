...
public class ParserUtil implements Words {
	...
	protected HiNode expectBody(Tokenizer tokenizer, CompileClassContext ctx) throws TokenizerException, ParseException {
		skipComments(tokenizer);
	...
	protected HiNode[] visitArgumentsValues(Tokenizer tokenizer, CompileClassContext ctx) throws TokenizerException, ParseException {
