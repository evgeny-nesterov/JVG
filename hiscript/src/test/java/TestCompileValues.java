...
public class TestCompileValues extends HiTest {
	...
	public void testCompileValue() throws HiScriptParseException, TokenizerException, HiScriptValidationException {
		assertSuccessSerialize("class A{final static Boolean x = true;} assert A.x == Boolean.TRUE;");
		assertSuccessSerialize("class A{final static boolean x = !false;} assert A.x;");

		for (String t : new String[] {"byte", "short", "char", "int", "long", "float", "double"}) {
			assertSuccessSerialize("class A{final " + t + " x = (byte)1;} assert new A().x == 1;");
			assertSuccessSerialize("class A{final " + t + " x = (short)1;} assert new A().x == 1;");
			assertSuccessSerialize("class A{final " + t + " x = (char)1;} assert new A().x == 1;");
			assertSuccessSerialize("class A{final " + t + " x = (int)1;} assert new A().x == 1;");

			for (String t1 : new String[] {"byte", "short", "char", "int"}) {
				assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")(1+2);} assert new A().x == 3;");
				for (String t2 : new String[] {"byte", "short", "char", "int"}) {
					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")1+(" + t2 + ")2;} assert new A().x == 3;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")1+(" + t1 + ")2;} assert new A().x == 3;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")2-(" + t2 + ")1;} assert new A().x == 1;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")2-(" + t1 + ")1;} assert new A().x == 1;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")2*(" + t2 + ")3;} assert new A().x == 6;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")2*(" + t1 + ")3;} assert new A().x == 6;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")6/(" + t2 + ")3;} assert new A().x == 2;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")6/(" + t1 + ")3;} assert new A().x == 2;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")5%(" + t2 + ")3;} assert new A().x == 2;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")5%(" + t1 + ")3;} assert new A().x == 2;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")7&(" + t2 + ")2;} assert new A().x == 2;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")7&(" + t1 + ")2;} assert new A().x == 2;");

					assertSuccessSerialize("class A{final " + t + " x = (" + t1 + ")5|(" + t2 + ")2;} assert new A().x == 7;");
					assertSuccessSerialize("class A{final " + t + " x = (" + t2 + ")5|(" + t1 + ")2;} assert new A().x == 7;");
				}
			}

			assertSuccessSerialize("class A{final double x = (" + t + ")(1+2);} assert new A().x == 3;");
		...
		assertSuccessSerialize("class A{final long x = 1L;}");
		...
		assertSuccessSerialize("class A{final float x = 1L;}");
		assertSuccessSerialize("class A{final float x = 1f;}");
		assertFailCompile("class A{final float x = 1.0;}", //
				"incompatible types; found double, required float");

		assertSuccessSerialize("class A{final double x = 1L;}");
		assertSuccessSerialize("class A{final double x = 1f;}");
		assertSuccessSerialize("class A{final double x = 1.0;}");
	}
}
