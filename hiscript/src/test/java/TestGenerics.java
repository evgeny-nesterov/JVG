...
//		TODO assertSuccessSerialize("class A<O>{O get(O v);} class B<O>{class C extends A<O>{O get(O v){return v;}}}");
	...
	public void testReturn() {
		assertSuccessSerialize("class C{<O extends Number> O get(){return (O)new Double(1.23);}}");
		...
		assertSuccessSerialize("class C{<O> O get(){return (O)\"abc\";}} String s = new C().get(); assert s.equals(\"abc\");");
		...
		assertSuccessSerialize("class C{<O> O get(O o){return o;}} C c = new C().get(new C()) assert c instanceof C;");
		assertSuccessSerialize("class C{<O extends Number> Number get(O o){return o;}} Number n = new C().get(1d); assert n.equals(new Double(1));");
		assertSuccessSerialize("class C{<O extends Number> O get(O o){return o;}} Float f = new C().get(1.23f); assert f == 1.23F;");
		assertSuccessSerialize("class C{<O1, O2> O1 get(O2 o2){return (O1)o2;}} String a = new C().get(\"a\"); assert a.equals(\"a\");");
		...
		assertSuccessSerialize("class A1{} class A2 extends A1{} interface I<O extends A1>{O get();} class B<O extends A2> implements I<O>{public O get(){return (O)new A2();}} assert new B<A2>().get() instanceof A2;");
		assertSuccessSerialize("class A1{} class A2 extends A1{} interface I<O1 extends A1>{O1 get();} class B<O2 extends A2> implements I<O2>{public O2 get(){return (O2)new A2();}} assert new B<A2>().get() instanceof A2;");
