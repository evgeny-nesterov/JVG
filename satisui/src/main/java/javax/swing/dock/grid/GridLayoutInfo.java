...
public class GridLayoutInfo implements java.io.Serializable {
	...
	boolean hasBaseline; /*
							* Whether or not baseline layout has been requested and one of the components has a valid baseline.
							*/
	...
	/**
	 * Creates an instance of GridLayoutInfo representing {@code GridLayout} grid cells with it's own parameters.
	 * 
	 * @param width
	 *            the columns
	 * @param height
